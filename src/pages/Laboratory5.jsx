...
export default function Laboratory5() {
  const tableHeading = [
    "COMPUTER #",
    "MOTHERBOARD",
    "PROCESSOR",
    ...
    <div className="bg-slate-100 p-6 sm:p-10">
      <div className="mx-auto max-w-8xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        <div className="flex items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Laboratory 5</h1>
              ...
              {loading ? (
                ...
                <tr>
                  <td className="px-4 py-4 text-sm text-slate-500" colSpan={tableHeading.length}>
                    No component records found for Laboratory 5.
                  </td>
                </tr>
              ) : (
                rows.flatMap((row) => {
