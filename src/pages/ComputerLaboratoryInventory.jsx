            ...
            {isHistoryOpen && (
                    <div className="mt-3 flex w-full flex-wrap items-center gap-3 overflow-visible">
                        ...
                        <div className="relative z-50">
                            ...
                            {showHistoryDatePicker && (
                                <div ref={historyDatePickerRef} className="absolute left-0 top-full z-50 mt-2 w-fit rounded-lg border border-slate-200/80 bg-gradient-to-b from-white to-slate-50/90 px-2 py-2 shadow-[0_24px_80px_rgba(15,23,42,0.16)] ring-1 ring-white/60 backdrop-blur-sm">
